...
using BasicCompany.Feature.Navigation.Views.Shared.Components.SitecoreComponent;
...
namespace BasicCompany.Project.BasicCompany.Rendering
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                // Add the languages supported by your Sitecore instance.
                var supportedCultures = new List<CultureInfo>
    {
        ...
        new CultureInfo("hi-IN")   // Hindi
                ...
                // Set the default culture (if needed).
                options.DefaultRequestCulture = new RequestCulture(culture: "en", uiCulture: "en"); // Default to English
